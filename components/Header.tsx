        ...
        <div className="bg-black bg-bg bg-cover bg-repeat sticky z-50 top-0">
          <div className="container">
            <div className="flex md:items-center flex-row w-full py-2">
              ...
              <div className='flex md:h-12 h-10 max-w-xl md:my-0 md:mx-4 items-center bg-white rounded md:rounded-full w-full pl-2 pr-3'>
                <input
                  type="text"
                  placeholder="What are you looking for?"
                  className="px-4 h-7 w-full outline-none bg-white text-gray-200"
                />
                <svg className='fill-black' stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" id="search" x="0px" y="0px" viewBox="0 0 24 24" height="30" width="30" xmlns="http://www.w3.org/2000/svg"><g><path d="M20.031,20.79c0.46,0.46,1.17-0.25,0.71-0.7l-3.75-3.76c1.27-1.41,2.04-3.27,2.04-5.31
